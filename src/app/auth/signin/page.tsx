          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 border-gray-300 dark:border-gray-600 focus:border-pink-500 focus:ring-pink-500"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 border-gray-300 dark:border-gray-600 focus:border-pink-500 focus:ring-pink-500"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-medium transition-all duration-200 disabled:opacity-50"
              >
                {loading ? (
